...
| 7 | o | Беззнаковое восьмеричное число | Беззнаковое восьмеричное число |
| 8 | s | Строка символов | Строка символов |
| 9 | u | Беззнаковое десятичное целое число | Беззнаковое десятичное целое число |
| 10 | x | Беззнаковое шестнадцатеричное целое число | Беззнаковое шестнадцатеричное целое число (любые буквы) |
| 11 | X | Беззнаковое шестнадцатеричное целое число (заглавные буквы) | Беззнаковое шестнадцатеричное целое число (любые буквы) |
| 12 | p | Адрес указателя | Адрес указателя |
| 13 | n | Количество символов, напечатанных до появления %n | Количество символов, считанных до появления %n |
| 14 | % | Символ % | Символ % |

Поддерживаемые флаги для `sprintf`:
...
Поддерживаемая ширина для `sprintf`:
...
Поддерживаемая длина для `sprintf`:
...
| 3 | L | Аргумент интерпретируется как длинный double (применяется только к спецификаторам с плавающей точкой − e, E и f). |


Функции `sprintf` поддерживают частичное и полное форматирование, включая спецификаторы, флаги, ширину, точность и длину.
